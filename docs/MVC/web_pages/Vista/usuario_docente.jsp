<%-- 
    Document   : usuario_docente
    Created on : 02-may-2023, 23:00:22
    Author     : Acer
--%>
...
<head>
    ...
    <link href="/proyectoADSI/CSS/usuario_docente.css" rel="stylesheet" type="text/css">
...
<body>
    <div id="cont" class="container text-center">
        ...
        <nav class="row mt-5">
            ...
            <div class="col-lg-4">
                <form>
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <button type="submit" value="BUSCAR" class="btn btn-warning" id="btn_txt">BUSCAR</button>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="col">
                <div class="col">
                    <abbr title="Crear Usuario"><a class="btn btn-light" id="delete_subray"  href="/proyectoADSI/Vistas/crearUsuarioDocente.jsp" target=""><i class="bi bi-person-fill-add"></i></a></abbr>
        ...
        <section class="row mt-5">
            <div class="col-1"></div>
            <div class="col">
                <label id="titulo">DOCENTES</label>
                <table id="tabla" class="table mt-3">
                    ...
                    <tbody>
                        <c:forEach var="usuD" items="${usuDocente}"><!--El usuDocente, lo saco del caso listarDocentes del controlador usuarios-->
                            <tr>
                                <th scope="row">${usuD.getCodigo()}</th>
                                <td>${usuD.getNum_documento()}</td>
                                <td>${usuD.getNombre1()} ${usuD.getNombre2()}</td>
                                <td>${usuD.getApellido1()} ${usuD.getApellido2()}</td>
                                <td>
                                    ...
                                    <abbr title="Asociación docente a asignaturas"><a href="" target="" class="btn btn-outline-success"><i class="bi bi-arrow-left-right"></i></a></abbr>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
